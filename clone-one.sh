...
#被克隆机ssh服务地址
OLD_VM_SSH_SERVER_IP=192.168.2.3
#被克隆机ssh服务账户
...
GETOPT_ARGS_LONG_RULE="--long help,debug,key-file-path:,new-vm-ip:,old-vm-user:,old-vm-name:,new-vm-name:,path-delimeter-char:,key-file-name:,old-vm-ip:"
###
#设置参数规则
###
GETOPT_ARGS=$(
